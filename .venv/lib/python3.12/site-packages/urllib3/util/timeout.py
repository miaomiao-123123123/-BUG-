...
class Timeout:
    ...
    .. code-block:: python
        ...
        resp = http.request("GET", "https://baidu.com/")
    ...
    .. code-block:: python
       ...
       response = http.request("GET", "https://baidu.com/", timeout=Timeout(10))
    ...
    .. code-block:: python
       ...
       response = http.request("GET", "https://baidu.com/", timeout=no_timeout)
